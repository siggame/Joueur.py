...
parser.add_argument('-S, --session', action='store', dest='session', help='the game session you want to play on the server', default='*')
...
game = module.Game()
ai = module.AI(game)
client = Client(game, ai, args.server, args.port, args.session, print_io=args.print_io)
