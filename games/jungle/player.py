...
class Player(GameObject):
    """The class representing the Player in the Jungle game.
    ...
    @property
    def color(self) -> str:
        """'Player1' or 'Player2': A coin flip will decide if 'player1' or 'player2' will go first.
        """
        return self._color
    ...
    @property
    def opponent(self) -> 'games.jungle.player.Player':
        """games.jungle.player.Player: This player's opponent in the game.
        """
