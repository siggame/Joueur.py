...
class AI(BaseAI):
    """ The AI you add and improve code inside to play Pirates. """
    ...
    def find_path(self, start: 'games.pirates.tile.Tile', goal: 'games.pirates.tile.Tile') -> List['games.pirates.tile.Tile']:
        """A very basic path finding algorithm (Breadth First Search) that when given a starting Tile, will return a valid path to the goal Tile.

        Args:
            start (games.pirates.tile.Tile): The starting Tile to find a path from.
            goal (games.pirates.tile.Tile): The goal (destination) Tile to find a path to.

        Returns:
            list[games.pirates.tile.Tile]: A list of Tiles representing the path, the the first element being a valid adjacent Tile to the start, and the last element being the goal.
        """
