...
class AI(BaseAI):
    """ The AI you add and improve code inside to play Checkers. """

    @property
    def game(self) -> 'games.checkers.game.Game':
        """games.checkers.game.Game: The reference to the Game instance this AI is playing.
        """
        return self._game # don't directly touch this "private" variable pls

    @property
    def player(self) -> 'games.checkers.player.Player':
        """games.checkers.player.Player: The reference to the Player this AI controls in the Game.
        """
    ...
    def end(self, won: bool, reason: str) -> None:
        ...
        # <<-- /Creer-Merge: end -->>
    def got_captured(self, checker: 'games.checkers.checker.Checker') -> None:
