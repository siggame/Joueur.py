...
class AI(BaseAI):
    ...
    def find_path(self, start, goal):
        ...
        Args:
            start (games.saloon.tile.Tile): the starting Tile
            goal (games.saloon.tile.Tile): the goal Tile
        Returns:
            list[games.saloon.tile.Tile]: A list of Tiles
